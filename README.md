...
- Tipografías ornamentales en modo oscuro para reforzar la identidad visual.
...
- Google Fonts para el modo oscuro ornamental, con fallback local si el navegador no puede cargarlas.
